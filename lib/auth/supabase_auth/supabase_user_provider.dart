...
class RicardoSupabaseUser extends BaseAuthUser {
  RicardoSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> ricardoSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = RicardoSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
