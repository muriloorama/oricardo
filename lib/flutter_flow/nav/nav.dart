...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const MeusCursosWidget() : const BoasVindasWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => appStateNotifier.loggedIn
              ? const MeusCursosWidget()
        ...
        FFRoute(
          ...
          path: '/arearestrita',
          requireAuth: true,
          builder: (context, params) => const AreaProfessorWidget(),
        ),
        FFRoute(
          name: 'meusCursos',
          path: '/cursos',
          requireAuth: true,
          builder: (context, params) => const MeusCursosWidget(),
        ),
        FFRoute(
          name: 'boasVindas',
          path: '/login',
