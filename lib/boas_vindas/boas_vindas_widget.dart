...
class _BoasVindasWidgetState extends State<BoasVindasWidget>
  ...
  void initState() {
    ...
    _model.whatsappTextController ??=
        TextEditingController(text: 'Coloque seu whatsapp correto');
                                                          ...
                                                          return WebViewAware(
                                                            child: AlertDialog(
                                                              title: const Text(
                                                                  'Seja Bem Vind!'),
                                                              content: const Text(
                                                                  'Aproveite a Plataforma de Cursos'),
                                                              actions: [
                                                                TextButton(
                                                                  onPressed: () =>
                                                                      Navigator.pop(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      ...
                                                      _model.apiResultDetalhesUsuario =
                                                          await GETUsuariosCall
                                                              .call(
                                                        userID: currentUserUid,
                                                      );
                                                      shouldSetState = true;
                                                      if ((_model
                                                              .apiResultDetalhesUsuario
                                                              ?.succeeded ??
                                                          true)) {
                                                        setState(() {
                                                          FFAppState().user =
